...
ARG CONVERSEJS_VERSION=1.0.0

LABEL org.label-schema.schema-version="1.0.0"
LABEL org.label-schema.name="movim/movim"
LABEL org.label-schema.description="The social platform shaped for your community"
LABEL org.label-schema.url="https://movim.eu/"
LABEL org.label-schema.application="movim"
